<template>
	<div class="carousel">
    <mt-swipe :auto="4000" style="width:100%;height:190px;background-color:orange;">
      <mt-swipe-item ><router-link to="/" ><img src="../../assets/homeImg/foodShow.jpg" alt="" style="width:100%;height:auto;"></router-link></mt-swipe-item>
